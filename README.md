# Ubuntu 20 Ansible Test Image #
[![Container Repository on Quay](https://quay.io/repository/samdoran/ubuntu20-ansible/status "Container Repository on Quay")](https://quay.io/repository/samdoran/ubuntu20-ansible)
...
To build your own version of this container, run:
    ...
    podman build -t ubuntu20-ansible -f Containerfile .
...
platforms:
  - name: role-test
    image: "samdoran/${MOLECULE_DISTRIBUTION:-ubuntu20}-ansible:latest"
